...
<template>
    <div>
        ...
        <div class="bg-surface-50 dark:bg-surface-950 px-6 py-20 md:px-20 lg:px-80 min-h-screen flex items-center justify-center">
            <div class="bg-surface-0 dark:bg-surface-900 p-8 md:p-12 shadow-md rounded-2xl w-full max-w-md mx-auto flex flex-col gap-8 border border-surface-200 dark:border-surface-700">
            <!-- Logo and Header -->
            <div class="flex flex-col items-center gap-4">
                ...
                <div class="flex flex-col items-center gap-2 w-full">
                    ...
                    <div class="text-center w-full">
                        ...
                        <Link :href="route('register')" class="text-primary font-medium ml-1 cursor-pointer hover:text-primary-emphasis">Create today!</Link>
                    </div>
                </div>
            </div>

            <!-- Status Message -->
            <div v-if="status" class="text-sm font-medium text-green-600 dark:text-green-400 text-center">
                {{ status }}
            </div>
            ...
            <form @submit.prevent="submit" class="flex flex-col gap-6 w-full">
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between w-full gap-3 sm:gap-0">
                    <div class="flex items-center gap-2">
                        ...
                        <label for="remember" class="text-surface-900 dark:text-surface-0 leading-normal">Remember me</label>
                    </div>
                    <Link v-if="canResetPassword" :href="route('password.request')" class="text-primary font-medium cursor-pointer hover:text-primary-emphasis">
